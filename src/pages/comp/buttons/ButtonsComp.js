      ...
      <div className={styles.CompButtons}>
        <div className={styles.ctWr}>
          ...
          <div className={styles.ctBd} id='Sizes'>
            ...
            <CodeBlockComponent text={ButtonTables.ButtonSizes} language="jsx" Copy={true} CodeTitle={"jsx"} />
          ...
          <div className={styles.ctBd} id='Variants'>
            ...
            <CodeBlockComponent text={ButtonTables.ButtonColors} language="jsx" Copy={true} CodeTitle={"jsx"} />
          </div>
          ...
          <div className={styles.ctBd}>
            ...
            <CodeBlockComponent text={ButtonTables.ButtonIcons} language="jsx" Copy={true} CodeTitle={"jsx"} />
          </div>
