  ...
  return (
    <div>
      ...
      <div className='ctHd'>
        ...
        <p>
          To implement this color palette on your project, you must first create a <span style={{color : 'var(--caution-05)'}}>css</span> file on your project and name it&nbsp; <code className='whiteText'>color.css</code>.
          and then copy the code below and paste it there. Or you can download <code className='whiteText'>color.css</code> from download button below.
        </p>
      </div>
      ...
      <div className='ctBd'>
          ...
          <p>Now, you can include <span style={{color : 'var(--caution-05)'}}>color.css</span> on your main css file by using <code>@import './color.css';</code>. then you can call it's variables
          using <code>var(--x)</code> in your class styles. See example below.  </p>
...
`} language="scss" showLineNumbers={false} theme={dracula} />
          ...
          <p>These color palette will serve it's own based on what is required, you can see the tables below for it's usage within elements.</p>
